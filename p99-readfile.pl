% Changed by Erik Räni <29-Dec-2015>
% Added line 20: seen() and removed usage of seeing(Old) and see(Old).
% Older version of the file did not close the file with seen().
